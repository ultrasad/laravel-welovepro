            ...
            <div class="card col1-element col-centered" data-social="item">
              <div class="gallery-item gallery-brand" data-height="1" data-width="1">
                @if(file_exists($brand->logo_image))
                  <a class="brand-event-url" title="{{ $brand->name }}" href="{{ URL::to('brand', $brand->url_slug) }}"><img src="{{ GlideImage::load($brand->logo_image)->modify(['w'=> 640]) }}" class="img-responsive" /></a>
                @else
